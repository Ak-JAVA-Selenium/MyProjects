...
public class b7_XPath_actiTime {
...
//			}
		...
		WebElement b = driver.findElement(By.xpath("//div[contains(text(),'- ALL ACTIVE PROJECTS -')][@class='selectedItem']"));
...
//		f.click();//div[@title='
		driver.findElement(By.xpath("//div[@title='"+d+"']//ancestor::td//preceding-sibling::td//div//div")).click();

		WebElement g = driver.findElement(By.cssSelector(".delete.button"));
		wait.until(ExpectedConditions.elementToBeClickable(g));
		g.click();

		driver.findElement(By.cssSelector("div.dialogWithPointerWrapper."
				+ "deleteDialog>:nth-child(1)>:nth-child(1)>div>:nth-child(6)>:first-child>div")).click();
